...
{
    [Header("Jelly mechanics")]
    public float bounceSpeed;
    //for stop bouncing back and forth.
    ...
    public void OnCollisionEnter(Collision other)
    {
        ...
        {
            Vector3 inputPoint = collisonPoints[i].point + (collisonPoints[i].normal * pressureOffset);
            ApplyPressureToPoint(inputPoint, pressure);
        }
